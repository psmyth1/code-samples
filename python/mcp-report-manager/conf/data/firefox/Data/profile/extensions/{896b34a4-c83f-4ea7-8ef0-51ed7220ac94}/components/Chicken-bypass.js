...
const kSCHEME = "chicken-bypass-896b34a4-c83f-4ea7-8ef0-51ed7220ac94";
const kPROTOCOL_NAME = "Security Bypass Protocol";
const kPROTOCOL_CONTRACTID = "@mozilla.org/network/protocol;1?name=" + kSCHEME;
const kPROTOCOL_CID = Components.ID("f8940eee-2e3b-4682-a5d1-71ca80aeeeee");
...
Protocol.prototype =
{
  ...
  newChannel: function(aURI)
  {
    var Chickenfoot = Components.
      classes["@uid.csail.mit.edu/Chickenfoot/;1"].
